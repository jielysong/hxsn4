...
//                            showUpgradeSuccess();
        ...
        Thread thr = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    mUpgradeStatus = TApplication.getOpenSDK().getDeviceUpgradeStatus(mDeviceSerial);
    ...
    private void startUpgrade() {
        ...
        Thread thr = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    TApplication.getOpenSDK().upgradeDevice(mDeviceSerial);
                    mTimer = new Timer();
                    mTimer.schedule(new TimerTask() {
                        @Override
                        public void run() {
    ...
    private void showVersionViewOnce() {
        ...
        Thread thr = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    mVersion = TApplication.getOpenSDK().getDeviceVersion(mDeviceSerial);
