...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final void onRefreshComplete() {
        Log.i("PullToRefreshBase","................onRefreshComplete................");
        if (isRefreshing()) {
            ...
            case MotionEvent.ACTION_UP: {
                if (mIsBeingDragged) {
                    ...
                    if (mState == State.RELEASE_TO_REFRESH && (null != mOnRefreshListener)) {
                        Log.i("PullToRefreshBase","................onTouchEvent.ACTION_UP...............");
    ...
    public final void setRefreshing(boolean doScroll) {
        ...
        if (!isRefreshing()) {
            Log.i("PullToRefreshBase","................setRefreshing................");
    ...
    protected final void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            if (viewState == State.REFRESHING || viewState == State.MANUAL_REFRESHING) {
                Log.i("PullToRefreshBase","................onRestoreInstanceState................");
    ...
    private void pullEvent() {
        ...
        if (newScrollValue != 0 && !isRefreshing()) {
            ...
            Log.i("PullToRefreshBase","................pullEvent................");
    ...
    public void setFooterRefreshEnabled(boolean enable) {
        if (enable != mFooterRefreshEnabled) {
            ...
            if (mFooterRefreshEnabled) {
                Log.i("PullToRefreshBase","................setFooterRefreshEnabled................");
                setState(State.RESET);
            } else {
